...
function Admininfo({ shownotif, setShownotif, setToggleMsg }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      db.collection("webinfo").onSnapshot((snapshot) => {
        const newWeb = snapshot.docs.map((doc) => doc.data());
        setWeb(newWeb);
      });
    };
    fetchData();
  ...
  return (
    <div>
      ...
      {admin.length > 0 ? (
        <div
          className="adminInfoSubCont"
          onClick={() => {
            setShownotif(false);
          }}
        >
          {web.map((val) => (
            <h1>About seller of {val.title}</h1>
          ))}
          ...
          <div className="adminAvatarCont">
            {admin.map((val) => (
              <Avatar src={val.imgURL} className="adminAvatar" />
            ))}
          </div>
          {admin.map((val) => (
            <div className="adminNameCont">
              <h1>
            ...
            <div className="socialCont">
              {val.facebook !== "" && (
                <div
                  className="fb"
                  onClick={() => {
                    window.open(val.facebook, "_blank");
                  }}
                >
                  <div className="svgs">
                    <img
              ...
              {val.instagram !== "" && (
                <div
                  className="ig"
                  onClick={() => {
                    window.open(val.instagram, "_blank");
                  }}
                >
                  <div className="svgs">
                    <img
              ...
              {val.youtube !== "" && (
                <div
                  className="yt"
                  onClick={() => {
                    window.open(val.youtube, "_blank");
                  }}
                >
                  <div className="svgs">
                    <img
              ...
              {val.twitter !== "" && (
                <div
                  className="tt"
                  onClick={() => {
                    window.open(val.twitter, "_blank");
                  }}
                >
                  <div className="svgs">
                    <img
              ...
              {val.mail !== "" && (
                <ButtonMailto
                  className="mail"
                  label={<EmailRoundedIcon style={{ color: "#673AB7" }} />}
                  mailto={`mailto:${val.mail}`}
                  // onClick={() => {
                  //   window.open(val.mail, "_blank");
                  // }}
                >
